    ...
    <footer className="relative bg-slate-950/50 border-t border-white/5 overflow-hidden">
      ...
      <div className="container-max py-16 md:py-24 flex flex-col items-center">
        ...
        <div className="flex items-center gap-3 mb-10 group cursor-pointer opacity-80 hover:opacity-100 transition-opacity">
          ...
          <span className="text-white font-black text-2xl tracking-tighter">Saptarshi<span className="text-primary">.dev</span></span>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="text-slate-500 text-sm font-medium tracking-wide">
            © {new Date().getFullYear()} Saptarshi Banerjee. All rights architected.
          </p>

    ...
    >
      ...
      <div className="flex flex-col flex-1">
        <div className="flex justify-between items-start mb-4">
          <h3 className="text-2xl font-black group-hover:text-primary transition-colors leading-tight" style={{ color: 'var(--text-main)' }}>
            {project.title}
          </h3>
        ...
        <div className="flex gap-4 pt-6 border-t border-white/5">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-white/5 text-xs font-bold hover:bg-white/10 hover:text-primary transition-all duration-300"

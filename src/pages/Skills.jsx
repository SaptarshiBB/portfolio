      ...
      <div className="container-max">
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-20">
          <button
            ...
            style={{ color: activeTab === 'all' ? '#ffffff' : 'var(--text-muted)' }}
          >
            ✨ All Expertise
          </button>
          {categories.map(c => (
            <button
              ...
              style={{ color: activeTab === c.key ? '#ffffff' : 'var(--text-muted)' }}
            >
              {c.label}
            </button>
          ))}
          ...
          {filteredCategories.map((category) => (
            <div key={category.key} className="animate-fade-up">
              <div className="flex items-center gap-4 mb-10">
                <h3 className="text-2xl font-black" style={{ color: 'var(--text-main)' }}>{category.label}</h3>
